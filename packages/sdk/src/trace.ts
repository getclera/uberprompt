...
export interface TracedCallArgs<T> {
  promptName: string;
  input: object;
  // fn receives the rendered prompt; return either a string (used as output) or a TracedCallResult
...
// Renders the prompt, times fn, writes a TraceDoc (including errors), returns fn's result.
